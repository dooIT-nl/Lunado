...
class OrderHandler:
    ...
    def get_shipping_option_by_preference(self, shipment: Shipment, customer: Customer, products: DmProducts, preference, is_delivery= False, packages=None):
        try:
    ...
    def book_shipment(self, shipment:Shipment, customer: Customer, products: DmProducts, is_delivery=False, packages=None):
        try:
