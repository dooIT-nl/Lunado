...
class Config(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            hide_book_carrier_btn=self.env["ir.config_parameter"].sudo().get_param("dmmodule.hide_book_carrier_btn", default=False),
    ...
    def set_values(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param("dmmodule.hide_book_carrier_btn", self.hide_book_carrier_btn)
