...
class Config(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            sale_order_to_hub=self.env["ir.config_parameter"]
            .sudo()
            .get_param("dmmodule.sale_order_to_hub", default=False),
            override_length=self.env["ir.config_parameter"]
            .sudo()
            .get_param("dmmodule.override_length", default=False),
    ...
    def update_delivery_orders(self):
        ...
        if self.hide_book_carrier_btn == True:
            for delivery_order in delivery_orders:
                delivery_order.write({"hide_book_carrier_btn": True})
        else:
            for delivery_order in delivery_orders:
                delivery_order.write({"hide_book_carrier_btn": False})
