...
class DmProduct:
    def __init__(self, content, description, weight, length, width, height, barcode, warehouse_id, value, stock, quantity,  sku, is_fragile=False, is_dangerous=False, hscode=None, country_origin=None, custom1=None):
        ...
        for attribute, value in vars().items():
            ...
            if not value and attribute not in ["is_fragile", "is_dangerous", "hscode", "country_origin", "stock", "warehouse_id", "custom1"]:                    
